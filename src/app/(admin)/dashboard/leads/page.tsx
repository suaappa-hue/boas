...
const SOURCE_BADGE_STYLES: Record<string, string> = {
  메타: "bg-blue-500/15 text-blue-300 border border-blue-500/25",
  홈페이지: "bg-teal-500/15 text-teal-300 border border-teal-500/25",
  기타: "bg-gray-500/15 text-gray-300 border border-gray-500/25",
};
...
> = {
  전체: {
    ...
    active: "bg-[#0f172e] text-white border-[#0f172e]",
    icon: "text-gray-500",
  },
  신규: {
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-1.5 flex-wrap">
                          <p className="font-medium text-gray-200 hover:text-blue-400 transition-colors">
                            {lead.기업명 || "-"}
                          </p>
                          {lead.출처 && (
                            <span
                              className={`text-[10px] leading-none px-1.5 py-0.5 rounded-md font-semibold ${SOURCE_BADGE_STYLES[lead.출처] || SOURCE_BADGE_STYLES["기타"]}`}
                            >
                              {lead.출처}
                            </span>
                          )}
