...
export const pageMetadata: Record<string, Metadata> = {
  home: {
    ...
    description:
      '중소기업 정책자금 전문 컨설팅 보아스 경영지원솔루션. 저금리 정책자금 조달, 벤처인증, 이노비즈 인증까지 기업 역량을 분석해 맞춤 자금조달 전략을 설계합니다. 무료 현황분석으로 시작하세요.',
    keywords:
    ...
    openGraph: {
      ...
      locale: 'ko_KR',
      type: 'website',
      images: [{ url: 'https://www.boas-solution.kr/images/og-image.png', width: 1200, height: 630, alt: '보아스 경영지원솔루션 - 정부정책자금 자금확보 전문가' }],
    },
    twitter: {
      card: 'summary_large_image',
      title: '보아스 경영지원솔루션 | 중소기업 정책자금·벤처인증 전문 컨설팅',
      description:
        '저금리 중소기업 정책자금, 맞춤 자금조달 전략. 무료 현황분석 신청하세요.',
    },
  ...
  fund: {
    ...
    description:
      '창업자금, 운전자금, 시설자금 등 중소기업 맞춤 정책자금 컨설팅. 연 2~4% 저금리 정책자금으로 자금조달 부담을 줄이세요. 무료 현황분석 제공.',
    openGraph: {
  ...
  contact: {
    ...
    description:
      '중소기업 정책자금 무료 상담 신청. 전문 컨설턴트가 1:1로 기업 현황을 분석하고 최적의 자금조달 전략을 제안합니다. 부담 없이 무료 현황분석으로 시작하세요.',
    keywords:
      '정책자금 상담, 무료 현황분석, 자금조달 상담, 중소기업 컨설팅, 보아스 경영지원솔루션 상담',
    openGraph: {
      title: '정책자금 무료 상담 신청 | 중소기업 자금조달 - 보아스 경영지원솔루션',
      description:
        '전문 컨설턴트 1:1 무료 현황분석. 대표님 맞춤 정책자금 전략을 제안합니다.',
