    ...
    <div className="fixed inset-0 z-50">
      ...
      >
        <div className="relative bg-[#141e33] lg:rounded-2xl max-lg:rounded-t-3xl shadow-2xl w-full lg:max-w-2xl max-h-[92vh] lg:max-h-[85vh] overflow-hidden flex flex-col">
          ...
          {toast && (
            <div
              className={`absolute top-4 left-1/2 -translate-x-1/2 z-20 px-4 py-2 rounded-lg text-sm font-medium shadow-lg transition-all ${
                toast.type === "success"
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div>
              <label className="block text-[12px] font-semibold text-gray-500 uppercase tracking-wider mb-3">
                상태 변경
              </label>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {fields.map((field) => (
                  <div
                    key={field.label}
                    className="bg-white/[0.04] rounded-xl px-4 py-3"
                  >
            ...
            <div>
              <label
                htmlFor="lead-memo"
                className="block text-[12px] font-semibold text-gray-500 uppercase tracking-wider mb-3"
              >
                관리자 메모
              </label>
              <textarea
